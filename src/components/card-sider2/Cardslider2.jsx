            ...
            <div className="card11-details22">
              <div className="card11-details22-center">
                ...
                <div className="sliderclintreview">
                  <p>
                  Easy booking with Mountain Nest! User-friendly website, competitive prices, and great support. Found perfect hotel at a great rate!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card11">
            ...
            <div className="card11-details22">
              <div className="card11-details22-center">
                ...
                <div className="sliderclintreview">
                  <p>
                  Mountain Nest exceeded expectations! Smooth booking process, excellent deals, and helpful team. Will definitely use again for future trips!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card11">
            ...
            <div className="card11-details22">
              <div className="card11-details22-center">
                ...
                <div className="sliderclintreview">
                  <p>
                  Love Mountain Nest! Easy to use, great selection, and amazing prices. Found my dream hotel, thanks to their excellent service
                  </p>
                </div>
              </div>
            </div>
